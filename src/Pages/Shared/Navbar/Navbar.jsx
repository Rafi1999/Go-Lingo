...
const Navbar = () => {
  ...
  <div className="badge badge-secondary">+{selected?.length || 0}</div>
    ...
    return (
        <>
        <div className="navbar fixed z-10 bg-opacity-30 max-w-screen-xl bg-black text-white md:h-20">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost font-serif normal-case text-sm mr-4 md:text-2xl"><FaLanguage></FaLanguage> Go-Lingo</a>
            </div>
